...
const adminMenuItems: NavMenuItem[] = [
    ...
    { key: "privacidad-admin", label: "Privacidad", path: "/legal/privacy", background: "/images/bg-privacy.jpg", role: "ROLE_ADMIN", viewAsUser: false },
    { key: "privacidad-user", label: "Privacidad", path: "/legal/privacy", background: "/images/bg-privacy-user.jpg", viewAsUser: true },
    { key: "cookies-admin", label: "Cookies", path: "/legal/cookies", background: "/images/bg-cookies.jpg", role: "ROLE_ADMIN", viewAsUser: false },
