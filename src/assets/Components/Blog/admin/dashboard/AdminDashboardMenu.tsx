...
const adminMenuItems: NavMenuItem[] = [
    ...
    { key: "terminos-admin", label: "Términos", path: "/terms", background: "/images/bg-terms.jpg", role: "ROLE_ADMIN", viewAsUser: false },
    { key: "terminos-user", label: "Términos", path: "/terms", background: "/images/bg-terms-user.jpg", viewAsUser: true },
    { key: "privacidad-admin", label: "Privacidad", path: "/privacy", background: "/images/bg-privacy.jpg", role: "ROLE_ADMIN", viewAsUser: false },
    { key: "privacidad-user", label: "Privacidad", path: "/privacy", background: "/images/bg-privacy-user.jpg", viewAsUser: true },
    { key: "cookies-admin", label: "Cookies", path: "/cookies", background: "/images/bg-cookies.jpg", role: "ROLE_ADMIN", viewAsUser: false },
    { key: "cookies-user", label: "Cookies", path: "/cookies", background: "/images/bg-cookies-user.jpg", viewAsUser: true },
